...
/**
 * {@link Comparator} for {@link Event}s based on the {@link Event#getName()}
 * value and their {@link TokenizingJaccardSimilarity} value.
 *
 * @author Daniel Ringler
 *
 */
public class EventNameComparatorJaccard extends Comparator<Event, DefaultSchemaElement> {
    ...
    public double compare(
        ...
        double similarity = sim.calculate(record1.getName(),
                record2.getName());
