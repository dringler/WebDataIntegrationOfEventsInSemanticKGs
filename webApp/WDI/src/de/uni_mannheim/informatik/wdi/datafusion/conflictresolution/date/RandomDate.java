...
/**
 * Random {@link ConflictResolutionFunction}: Returns a random date value.
 * @author Daniel Ringler
 *
 * @param <ValueType>
 * @param <RecordType>
 */
public class RandomDate<ValueType, RecordType extends Matchable & Fusable<SchemaElementType>, SchemaElementType> extends ConflictResolutionFunction<ValueType, RecordType, SchemaElementType> {
