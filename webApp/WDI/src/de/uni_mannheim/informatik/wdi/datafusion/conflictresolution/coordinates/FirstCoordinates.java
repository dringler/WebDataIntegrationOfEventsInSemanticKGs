package de.uni_mannheim.informatik.wdi.datafusion.conflictresolution.coordinates;
...
/**
 * Random {@link ConflictResolutionFunction}: Returns the first coordinates value.
 * @author Daniel Ringler
 *
 * @param <ValueType>
 * @param <RecordType>
 */
public class FirstCoordinates<ValueType, RecordType extends Matchable & Fusable<SchemaElementType>, SchemaElementType> extends ConflictResolutionFunction<ValueType, RecordType, SchemaElementType> {
