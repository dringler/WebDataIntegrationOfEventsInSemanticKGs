...
/**
 * Wrapper for a list of values during the data fusion process
 *
 ...
 * @param <RecordType>
 */
public class FusableValues<ValueType, RecordType extends Matchable & Fusable<SchemaElementType>, SchemaElementType> {
     ...
     * @param dataset
     */
    public FusableValues(List<ValueType> values, RecordType record,
